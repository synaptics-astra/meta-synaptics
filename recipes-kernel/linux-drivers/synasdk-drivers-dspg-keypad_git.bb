SUMMARY = "DSPG Keypad Kernel Module"
DESCRIPTION = "${SUMMARY}"
...
KERNEL_MODULE_AUTOLOAD:append:myna2 = " dspg-keypad"
KERNEL_MODULE_PROBECONF:append:myna2 = " dspg-keypad"
...
RPROVIDES:${PN} += "kernel-module-dspg-keypad"
