SUMMARY = "DSPG Hookswitch Kernel Module"
DESCRIPTION = "${SUMMARY}"
...
KERNEL_MODULE_AUTOLOAD:append:myna2 = " dspg-hookswitch"
KERNEL_MODULE_PROBECONF:append:myna2 = " dspg-hookswitch"
...
RPROVIDES:${PN} += "kernel-module-dspg-hookswitch"
