SUMMARY = "Synaptics Dolphin Clock Driver Kernel Module"
DESCRIPTION = "${SUMMARY}"
...
KERNEL_MODULE_AUTOLOAD:append = " dolphin-clks"
KERNEL_MODULE_PROBECONF:append = " dolphin-clks"
...
S = "${WORKDIR}/${SYNA_MODULES_SOURCE_PREFIX}/drivers/clk/berlin/dolphin-clks"

do_install:append() {
    rm -f ${D}/lib/modules/${KERNEL_VERSION}/extra/modules.order.*
}

RPROVIDES:${PN} += "kernel-module-dolphin-clks"
