SUMMARY = "System Manager Driver Kernel Module"
DESCRIPTION = "${SUMMARY}"
...
KERNEL_MODULE_AUTOLOAD:append = " sm"
KERNEL_MODULE_PROBECONF:append = " sm"
...
S = "${WORKDIR}/${SYNA_MODULES_SOURCE_PREFIX}/drivers/soc/berlin/modules/sm"

do_install:append() {
    rm -f ${D}/lib/modules/${KERNEL_VERSION}/extra/modules.order.*
}

PROVIDES = "kernel-module-sm"
