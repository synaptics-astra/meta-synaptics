...
SRC_URI = "${GITHUB_BASE_URI}/download/${PV}/meson-${PV}.tar.gz \
           ...
           file://meson-setup-tee.py \
           file://0009-envconfig-Add-support-for-secure-operation-system.patch \
           "
...
do_install:append:class-nativesdk() {
    ...
    install -m 0755 ${WORKDIR}/meson-setup-tee.py ${D}${SDKPATHNATIVE}/post-relocate-setup.d/
...
do_install:append:class-native() {
    ...
    install -m 0755 ${WORKDIR}/meson-setup-tee.py ${D}${datadir}/post-relocate-setup.d/
